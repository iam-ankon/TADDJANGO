...
class EmployeeLeave(models.Model):
    ...
    def send_leave_email(self):  # changed from instance to self
        ...
        <body>
            ...
            <p><a href="http://119.148.12.1:3000/edit-leave-request/{self.id}">View Leave Request</a></p>
...
def email(sender, instance, **kwargs):
    ...
    frontend_url = "http://119.148.12.1:3000/interviews"
...
def send_leave_email(sender, instance, created, **kwargs):
    ...
    <body>
        ...
        <p>You can review this request by clicking the link below:</p>
        <p><a href="http://119.148.12.1:3000/edit-leave-request/{instance.id}">View Leave Request</a></p>
