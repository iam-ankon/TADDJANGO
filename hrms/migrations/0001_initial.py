    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ManyToManyField(blank=True, related_name='employees', to='hrms.customers')),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='employees', to='hrms.tadgroups')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='hrms.employeedetails')),
            ],
        ),
        migrations.CreateModel(
            name='Attendance',
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hrms.employeedetails')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='terminated_employees', to='hrms.tadgroups')),
            ],
        ),
        migrations.CreateModel(
            name='EmployeeLeave',
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hrms.employeedetails')),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hrms.tadgroups')),
            ],
        ),
        migrations.CreateModel(
