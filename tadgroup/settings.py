...
SECRET_KEY = 'django-insecure-dxpw45)5xpr8vzr%kd4iz)#_6xuz_)eeb2qs458uu$pzm=m5y='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["119.148.12.1", "localhost", "127.0.0.1",'*']
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://192.168.5.185:3000",   # your PC's local IP
    "http://119.148.12.1:3000",    # your public IP
]

CORS_ALLOW_CREDENTIALS = True

CSRF_TRUSTED_ORIGINS = [
    "http://192.168.5.185:3000",
    "http://119.148.12.1:3000",
]
...
WSGI_APPLICATION = 'tadgroup.wsgi.application'
...
TIME_ZONE = 'Asia/Dhaka'  # Change to your correct time zone
